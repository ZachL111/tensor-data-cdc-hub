"""Regression checks for the tensor-data-cdc-hub casebook."""
...
from casebook.harness import assert_expected, tensor_data_cdc_hub_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(tensor_data_cdc_hub_summary(), assert_expected())
